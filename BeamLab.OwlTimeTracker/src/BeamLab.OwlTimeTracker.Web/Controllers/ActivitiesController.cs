...
namespace BeamLab.OwlTimeTracker.Web.Controllers
{
    public class ActivitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Description,End,Start")] Activity activity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Description,End,Start")] Activity activity)
        {
            if (id != activity.ID)
            {
                return NotFound();
