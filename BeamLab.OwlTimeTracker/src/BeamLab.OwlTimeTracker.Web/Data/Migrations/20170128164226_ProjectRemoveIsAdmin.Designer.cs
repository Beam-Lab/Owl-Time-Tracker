...
namespace BeamLab.OwlTimeTracker.Web.Data.Migrations
{
    ...
    [Migration("20170128164226_ProjectRemoveIsAdmin")]
    partial class ProjectRemoveIsAdmin
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("BeamLab.OwlTimeTracker.Web.Models.Activity", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("BeamLab.OwlTimeTracker.Web.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BeamLab.OwlTimeTracker.Web.Models.ApplicationUser")
                        .WithMany("Claims")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
